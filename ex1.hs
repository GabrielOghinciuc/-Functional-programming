...
-- functie de concatenare pentru stringuri
concatStr :: String -> (String -> String)
concatStr x y = x ++ y

-- o functie care aplică o funcție de două ori
...
-- o altă functie (versiunea 1 de g)
g2 :: Integer -> Integer -> Integer
g2 0 x = x + 1
g2 (n + 1) 0 = g2 n 1
g2 (n + 1) (x + 1) = g2 n (g2 (n + 1) x)

-- functia Ackermann (versiunea finală de g)
